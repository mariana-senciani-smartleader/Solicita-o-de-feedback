...
const StatusBadge = ({ status }: { status: ScheduledPost["status"] }) => {
  ...
  const s = map[status];
  return (
    <span style={{ display: "inline-flex", alignItems: "center", gap: 5, fontSize: 12, fontWeight: 500, color: s.color, background: s.bg, borderRadius: 99, padding: "2px 10px 2px 8px", whiteSpace: "nowrap" }}>
